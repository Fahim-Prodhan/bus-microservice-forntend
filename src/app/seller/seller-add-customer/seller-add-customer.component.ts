...
@Component({
  selector: 'app-seller-add-customer',
  templateUrl: './seller-add-customer.component.html',
  styleUrls: ['./seller-add-customer.component.css']
})
export class SellerAddCustomerComponent implements OnInit{
